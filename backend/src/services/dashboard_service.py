...
class DashboardService:
    ...
    def _get_summary(self, start_date: date, end_date: date) -> DashboardSummary:
        ...
        period_expenses = self.transaction_repository.get_period_expenses(start_date, end_date)
    ...
    def _get_expenses_by_category(self, start_date: date, end_date: date) -> List[CategorySummary]:
        category_stats = self.transaction_repository.get_expenses_by_category(start_date, end_date)
        return [
            CategorySummary(
                category_name=name,
